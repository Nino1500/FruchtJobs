...
public class Fischer extends Job {
    ...
    public ArrayList<MaterialsLog> items = new ArrayList<>();
    public ArrayList<MaterialsEntityLog> monsters = new ArrayList<>();

    public Fischer(int max_level, String name, ChatColor color, Material gui, String description, String permission, ArrayList<MaterialsLog> items, ArrayList<MaterialsEntityLog> monsters) {
